...
- **Diagnostic and clock semantics** (landed 2026-08-31) — synthetic
  ...
  (impact-timing train, trajectory radiography, asymmetry mode set, shot-outcome set, synthetic oscillator); `computational_prototype` (ADR 0003,
...
Laser- and beam-driven ICF, mechanical/liquid liner MIF, magnetic
