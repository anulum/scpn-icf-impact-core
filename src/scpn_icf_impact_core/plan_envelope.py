...
# SCPN ICF Impact Core — portable diagnostic-plan envelope
...
PROJECT: Final = "SCPN-ICF-IMPACT-CORE"
...
class PlanEnvelope:
    ...
    binding
        ...
        embedded :data:`~scpn_icf_impact_core.observability.CATALOGUE_BINDING`.
    plan_identifier
