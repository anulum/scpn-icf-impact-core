...
# SCPN ICF Impact Core — diagnostic and clock semantics
...
identities for the impact-driven inertial-confinement configuration this
...
from scpn_icf_impact_core.configuration import ConsistencyFinding
...
ASYMMETRY_BAND_HZ: Final = (1.0e05, 1.0e09)
DRIVER_TIMING_CEILING_S: Final = 1.0e-08

SHOT_DURATION_CEILING_S: Final = 1.0e-05
        ...
        for configuration in self.configurations:
            if configuration not in OWNED_CONFIGURATIONS:
                raise DiagnosticPlanError(
                    ...
                    f"{configuration!r} is not owned by SCPN-ICF-IMPACT-CORE"
                )
    ...
    def __post_init__(self) -> None:
        ...
        if self.candidate_id not in _CANDIDATE_INDEX:
            raise DiagnosticPlanError(
                ...
                "applicable to SCPN-ICF-IMPACT-CORE"
            )
        if not self.reason:
...
class DiagnosticPlan:
    ...
    def consistency_report(self) -> tuple[ConsistencyFinding, ...]:
        ...
        tuple of ConsistencyFinding
            Findings from documented impact-ICF diagnostic practice; empty
                ...
                findings.append(
                    ConsistencyFinding(
                        ...
                        message=(
                            ...
                            "Hz is outside the impact-compression "
                            "asymmetry range 0.1 MHz-1 GHz "
                            "(LA-8000-C 1979)"
                        ),
                    )
                )
                ...
                findings.append(
                    ConsistencyFinding(
                        ...
                        message=(
                            ...
                            "longer than the impact-ICF event scale of up to "
                            "~10 us (LA-8000-C 1979)"
                        ),
                    )
                )
