...
# SCPN ICF Impact Core — portable diagnostic-plan envelope tests
...
FIXTURE_SHA256 = "05354430350056a64735e25bec70e4064339b6881eb1c80f143a692d8295afce"
...
def test_constants_are_the_published_contract() -> None:
    ...
    assert PROJECT == "SCPN-ICF-IMPACT-CORE"
    assert NON_CLAIMS == (
