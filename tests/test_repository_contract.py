...
# SCPN ICF Impact Core — repository-level truth tests
...
REQUIRED_PATHS = (
    ...
    "src/scpn_icf_impact_core/__init__.py",
    "src/scpn_icf_impact_core/configuration.py",
    "src/scpn_icf_impact_core/errors.py",
    "src/scpn_icf_impact_core/observability.py",
    "src/scpn_icf_impact_core/plan_envelope.py",
    "tests/data/plan_envelope_fixture.json",
    "src/scpn_icf_impact_core/parameters.py",
    "docs/adr/0005-level0-device-physics.md",
    "src/scpn_icf_impact_core/physics/__init__.py",
    "src/scpn_icf_impact_core/physics/compression.py",
...
def test_manifest_declares_exact_configuration_assignment() -> None:
    ...
    assert manifest["project"] == "SCPN-ICF-IMPACT-CORE"
...
def test_package_agrees_with_manifest_truth() -> None:
    ...
    from scpn_icf_impact_core import OWNED_CONFIGURATIONS, RegistryBinding
